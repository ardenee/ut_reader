...
function renderRawHeaderFields(array $fields): void
{
    ...
    foreach ($fields as $f) {
        echo '<tr>';
        echo '<td class="mono">' . h((string)($f['offset'] ?? '')) . '</td>';
        echo '<td class="mono">' . h((string)($f['size'] ?? '')) . '</td>';
        echo '<td class="mono">' . h((string)($f['name'] ?? '')) . '</td>';
        echo '<td class="mono">' . h((string)($f['type'] ?? '')) . '</td>';
        echo '<td class="mono raw">' . h(raw_header_value_text($f['value'] ?? '')) . '</td>';
        echo '<td class="mono raw">' . h((string)($f['rawHex'] ?? '')) . '</td>';
        echo '<td class="raw">' . h((string)($f['note'] ?? '')) . '</td>';
        echo '</tr>';
    }
