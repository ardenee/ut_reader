 ...
 * Purpose: Supports the standalone `UE1` parser/viewer workflow for UE1.
 * Why: It exists for `UE1` package-format inspection, experiments, or parser development separate from the main
 *      catalog UI.
