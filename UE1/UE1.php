...
<body>
<div class="workspace">
<div class="doc-tabs"><div class="doc-tab"><?= h(
    basename($filePath)
) ?></div></div>
<div class="viewer">
<div class="toolbar"><div class="file-open-bar"><form method="get"><select class="file-select" name="file"><?php
if (
...
<section id="package-panel" class="panel active"><div class="package-grid"><div class="field-grid"><div class="field-label">GUID</div><div class="field-value mono"><?= h(
    ...
    hx((int) ($hdr["signature"] ?? 0))
) ?></div></div><div class="field-grid"><div class="field-label">Flags</div><div class="field-value mono"><?= h(
    hx((int) ($hdr["pkgFlags"] ?? 0))
) ?></div><div class="field-label">Build</div><div class="field-value">Unreal1</div><div class="field-label">Heritage</div><div class="field-value mono"><?= h(
    ($hdr["heritageCount"] ?? "") .
        (($hdr["heritageOffset"] ?? "") !== ""
            ? " / " . ($hdr["heritageOffset"] ?? "")
            : "")
...
<div id="gens-sub" class="subpanel"><h2>Generations (<?= count(
    $hdr["generations"] ?? []
) ?>)</h2><table class="data"><thead><tr><th>ExportCount</th><th>NameCount</th><th>Num.</th><th>Raw</th></tr></thead><tbody><?php foreach (
    $hdr["generations"] ?? []
    as $i => $g
): ?><tr><td><?= h($g["e"] ?? "") ?></td><td><?= h(
    $g["n"] ?? ""
