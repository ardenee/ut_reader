 ...
 * Purpose: Supports the standalone `UE4` parser/viewer workflow for UE4.
 * Why: It exists for `UE4` package-format inspection, experiments, or parser development separate from the main
 *      catalog UI.
