...
function renderExportNode(
    ...
    echo '<details id="' .
        h($anchor) .
        '" class="tree-node" open data-filter-row>';
...
if (
    is_file(__DIR__ . "/test.utx")
): ?><option value="test.utx"<?= $currentRel === "test.utx"
    ? " selected"
    : "" ?>>test.utx</option><?php endif;
if (
    is_file(__DIR__ . "/oldtest.utx")
): ?><option value="oldtest.utx"<?= $currentRel === "oldtest.utx"
    ? " selected"
    : "" ?>>oldtest.utx</option><?php endif;
...
if (
    ...
    ? "Yes"
    : "No" ?></td></tr><tr><th>Total compressed / uncompressed</th><td class="mono"><?= h(
...
?></section>
<section id="content-panel" class="panel"><div class="content-list"><?php foreach (
    $exports
    as $i => $ex
...
<section id="externs-panel" class="panel"><div class="tree-box"><?php
...
<div id="exports-sub" class="subpanel"><h2>Exports Tree (<?= h(
    ...
    $hdr["exportOffset"] ?? ""
) ?>)</h2><div class="tree-box"><?php foreach ($exports as $i => $_ex) {
    renderExportNode(
        $pkg,
        $exports,
        $exportsByOuter,
...
?></td></tr><?php
endforeach; ?></tbody></table></details></div></div>
<div id="imports-sub" class="subpanel"><h2>Imports Tree (<?= h(
    $hdr["importCount"] ?? ""
) ?>:<?= h(
    $hdr["importOffset"] ?? ""
) ?>)</h2><div class="tree-box"><?php foreach ($imports as $i => $_im) {
    renderImportNode(
        $pkg,
        $imports,
        $importsByOuter,
