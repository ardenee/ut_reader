 ...
 * Purpose: Implements the standalone `UE2` Unreal package reader and its supporting binary/package structures.
 * Why: It decodes `UE2` package formats for parser development and for catalog reader bridges that explicitly load
 *      it.
