 ...
 * Purpose: Accepts local package uploads for the standalone `UE2` reader/viewer.
        ...
        if ($err !== UPLOAD_ERR_OK) {
            ...
            if (!in_array($ext, $allowed, true)) {
                ...
                if (move_uploaded_file($tmp, $target)) {
                    @chmod($target, 0664);
                    header('Location: UE2.php?file=uploads/' . rawurlencode($name));
                    exit;
                }
...
<head>
<meta charset="utf-8">
<title>Upload UE2 package</title>
<style>
...
<p class="hint">Files are saved to <code>UE2/uploads/</code> and then opened in <code>UE2.php</code>.</p>
<p><a href="UE2.php">Back to UE2 viewer</a></p>
</div>
</body>
</html>
