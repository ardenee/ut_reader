 ...
 * Purpose: Exposes the standalone `UE2` package upload route through the shared standalone UI helper.
 * Why: It preserves the existing parser-development URL without duplicating upload validation and presentation code.
 * Role: Thin engine-specific adapter that supplies the `UE2` label and allowed extensions.
...
\UtReader\Standalone\StandalonePackageUi::renderUploadPage('UE2', __DIR__, ['u', 'utx', 'umx', 'uax', 'unr', 'ut2', 'ut3', 'upk']);
