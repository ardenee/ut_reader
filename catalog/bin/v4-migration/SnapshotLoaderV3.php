<?php
/**
 * Offline format-3 snapshot loader used only by the v3 -> v4 migration.
 * Production runtime must not support prior metadata formats. Future v5+
 * migrations should add an equivalent prior-format loader under their own
 * migration directory.
 */
...
final class SnapshotLoaderV3
{
    ...
    public function load(int $fileId): array
    {
        ...
        $reader = new MetadataReaderV3($this->db, $this->storageRoot);
