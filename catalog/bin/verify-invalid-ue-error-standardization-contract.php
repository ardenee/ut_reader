...
$record(
    ...
    str_contains($indexer, 'method_exists($reader, \'getValidationIssues\')')
        ...
        && str_contains($bucket, 'CatalogInvalidUeErrorClassifier::classify(')
        && str_contains($bucket, '\'error_code\' => $validation[\'code\']')
        && str_contains($bucket, '\'arguments\' => $validation[\'arguments\']')
        && str_contains($staged, 'CatalogInvalidUeErrorClassifier::classify(')
        && str_contains($staged, '\'arguments\' => $validation[\'arguments\']')
