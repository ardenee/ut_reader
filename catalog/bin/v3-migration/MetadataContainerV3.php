...
namespace UnrealDb\Catalog\MigrationV3;
...
final class MetadataContainerV3
{
            ...
            switch ($section) {
                case 'names':
                    $encoded[] = [
                        ...
                        ($row['first_import_index'] ?? null) !== null ? (int)$row['first_import_index'] : null,
                        ($row['first_export_index'] ?? null) !== null ? (int)$row['first_export_index'] : null,
                    ];
                    break;
                ...
                case 'imports':
                    ...
                    $encoded[] = [
                        ...
                        (int)$row['is_common'],
                        ($row['class_package_name_index'] ?? null) !== null ? (int)$row['class_package_name_index'] : null,
                        ($row['class_name_index'] ?? null) !== null ? (int)$row['class_name_index'] : null,
                        ($row['object_name_index'] ?? null) !== null ? (int)$row['object_name_index'] : null,
                    ];
                    break;
                ...
                case 'dependencies':
                    [$status, $source, $confidence] = \UnrealDb\Catalog\Infrastructure\Metadata\CompressedMetadataLegacySnapshot::dependencyCodes(
