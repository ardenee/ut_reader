 ...
 * Purpose: Handles the signed federation request-item status update HTTP endpoint.
...
try {
    ...
    $result = (new CatalogFederationRequestApiService($db))->updateItemStatus($peer, $payload);
