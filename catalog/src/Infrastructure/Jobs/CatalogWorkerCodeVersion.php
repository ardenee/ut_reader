...
final class CatalogWorkerCodeVersion
{
    ...
    public function current(bool $refresh = false): string
    {
        ...
        $paths = [
            ...
            $this->catalogRoot . '/src/Infrastructure/Persistence/PdoArchiveProfileMismatchOutcomeRepair.php',
            $this->catalogRoot . '/src/Infrastructure/Persistence/PdoInvalidUeSystemErrorBackfill.php',
