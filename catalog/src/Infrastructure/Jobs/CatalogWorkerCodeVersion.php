...
final class CatalogWorkerCodeVersion
{
    ...
    public function current(bool $refresh = false): string
    {
        ...
        $paths = [
            ...
            $this->catalogRoot . '/src/Infrastructure/Redirect/CatalogRedirectArchiveValidationException.php',
            $this->catalogRoot . '/src/Infrastructure/Redirect/CatalogRedirectArchiveProcessor.php',
            $this->catalogRoot . '/src/Infrastructure/Jobs/CatalogRedirectArchiveStream.php',
            $this->catalogRoot . '/lib/CatalogRedirectArchivePayload.php',
            ...
            $this->catalogRoot . '/src/Infrastructure/Jobs/GeneratedPackageJobHandler.php',
            $this->catalogRoot . '/src/Infrastructure/Downloads/PdoCatalogPackageExportPlanner.php',
            $this->catalogRoot . '/lib/GeneratedPackageBuilder.php',
            $this->catalogRoot . '/src/Infrastructure/Downloads/CatalogPayloadZipWriter.php',
            $this->catalogRoot . '/src/Infrastructure/Downloads/CatalogGeneratedUmodWriter.php',
            $this->catalogRoot . '/src/Infrastructure/Downloads/CatalogUt4PakWriter.php',
            ...
            $this->catalogRoot . '/src/Infrastructure/Telemetry/CatalogSystemErrorRecorder.php',
            ...
            $this->catalogRoot . '/lib/GameProfiles.php',
            $this->catalogRoot . '/parsers/EpicUE3PackageReader.php',
            $this->catalogRoot . '/lib/LzoDecoder.php',
            $this->catalogRoot . '/lib/LzxDecoder.php',
            ...
            $this->catalogRoot . '/src/Infrastructure/Jobs/CatalogUnverifiedMetadataRepairJobHandler.php',
            $this->catalogRoot . '/src/Infrastructure/Import/CatalogUnverifiedMetadataRepairProcessor.php',
            $this->catalogRoot . '/src/Infrastructure/Unverified/CatalogUnverifiedMetadataRepairService.php',
            $this->catalogRoot . '/src/Infrastructure/Unverified/CatalogUnverifiedStagingIndex.php',
            ...
            $this->catalogRoot . '/src/Infrastructure/Jobs/CatalogJobStorageCleanup.php',
            $this->catalogRoot . '/src/Infrastructure/Jobs/CatalogStorageMaintenanceJobHandler.php',
            $this->catalogRoot . '/src/Infrastructure/Jobs/CatalogProfiledUploadBatchJobHandler.php',
            $this->catalogRoot . '/src/Infrastructure/Import/CatalogProfiledUploadBatchStore.php',
