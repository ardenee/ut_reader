 ...
 * Why: Settings policy and storage should not be mixed with request blocking, rate limiting or file streaming.
 * Role: Infrastructure security settings boundary preserving the existing public-access configuration contract.
 */
