 ...
 * Purpose: Defines the infrastructure query `PdoPackageTablePageQuery` for package table paging and lookups.
 * Why: It keeps this responsibility in the namespaced architecture instead of repeating it in page, API, or worker
 *      entry points.
 * Role: Infrastructure implementation for compact metadata reads and legacy PDO fallback queries.
