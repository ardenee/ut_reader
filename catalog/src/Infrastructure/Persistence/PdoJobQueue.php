 ...
 * Worker fingerprint marker: affected-dependency batching v4 / simple valid-job claim scheduler v1 / contention-safe legacy compaction v1 / nonblocking claim coordination v2.
 */
