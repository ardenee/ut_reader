...
function catalog_admin_navigation_groups(string $root): array
{
    return [
        ...
        'Federation' => [
            ...
            'Generate Missing Dependency Request' => $root . 'federation/request-generate.php',
            'Request Status' => $root . 'federation/request-status.php',
            'Approved Dependency Downloads' => $root . 'federation/approved-downloads.php',
            'Child Inventory' => $root . 'federation/peer-inventory.php',
            'Child Dependency Requests' => $root . 'federation/requests.php',
