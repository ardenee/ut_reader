 ...
 * Purpose: Provides the legacy global `CatalogAffectedDependencyRefreshService` name as an alias of the namespaced
 *          `UnrealDb\\Catalog\\Application\\Dependency\\CatalogAffectedDependencyRefreshService` implementation.
...
class_alias('UnrealDb\\Catalog\\Application\\Dependency\\CatalogAffectedDependencyRefreshService', 'CatalogAffectedDependencyRefreshService');
