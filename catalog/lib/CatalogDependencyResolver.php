 ...
 * Purpose: Provides the legacy global `CatalogDependencyResolver` name as an alias of the namespaced
 *          `UnrealDb\\Catalog\\Application\\Dependency\\CatalogDependencyResolver` implementation.
...
class_alias('UnrealDb\\Catalog\\Application\\Dependency\\CatalogDependencyResolver', 'CatalogDependencyResolver');
