-- Adds logical package aliases for files that share the same physical identity.
-- Safe to run on an existing catalog before or after deploying the alias-aware code.
