...
try {
    ...
    echo '<style>'
        ...
        . '.access-matrix-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;margin-bottom:16px;max-width:100%}'
        . '.access-matrix-grid .ui-section{margin:0;min-width:0;max-width:100%;overflow:hidden}'
        . '.access-matrix-grid .ui-section__body{min-width:0;max-width:100%;overflow-x:auto}'
        . '.access-matrix-grid table{width:100%;max-width:100%;table-layout:fixed}'
        . '.access-matrix-grid th,.access-matrix-grid td{overflow-wrap:anywhere;word-break:break-word}'
        . '.access-matrix-grid th:not(:first-child),.access-matrix-grid td:not(:first-child){width:1%;white-space:nowrap}'
