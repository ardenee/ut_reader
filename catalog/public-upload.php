...
try {
    ...
    echo '<section class="card"><h2>How contribution upload works</h2>'
        ...
        . '<p class="muted">Public upload accepts normal Unreal package files plus .uz2 and .uz3 redirects. ZIP, RAR and 7z may be selected as local source archives; only eligible extracted Unreal members can cross the network. Legacy .uz FCodec redirects, UMOD-family archives and PAK containers remain excluded from the anonymous upload surface.</p>'
        . '</section>';
    ...
    echo '<section class="card"><h2>Select files</h2>'
        ...
        . ', .uz2, .uz3; source archives: .zip, .rar, .7z.</p>'
