...
try {
    ...
    catalog_stat_card('Missing dependencies', $missingDependencies, 'Missing dependency object rows across all games.', $missingDependencies > 0 ? 'attention' : 'good');
    ...
    catalog_tool_card('Missing files', 'missing.php', 'Review dependency gaps and request files from a parent site.', $missingDependencies > 0 ? (string)$missingDependencies : '');
    echo '</div></div>';
    ...
    if (!$games) {
        ...
        echo '<table><tr><th>Game</th><th>Profile engine</th><th>Files</th><th>Verified</th><th>Failed</th><th>Missing dependencies</th><th>Open</th></tr>';
