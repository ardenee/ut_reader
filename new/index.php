 ...
 * Purpose: Renders a simple directory index for the standalone `new` parser/reference folder.
 ...
 * Audit: Exact duplicate in this snapshot of `UE1/index.php`, `UE2/index.php`, `UE3/index.php`; consolidation
