 ...
 * Purpose: Supports the standalone `new` parser/viewer workflow for view names.
...
print_r($exports);
echo "</pre>";
// 206  - names table, 2461 - export table, 27   - import table, the value is showing as 'Brush_10'
?>
