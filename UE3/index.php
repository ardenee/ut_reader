 ...
 * Purpose: Renders a simple directory index for the standalone `UE3` parser/reference folder.
 ...
 * Audit: Exact duplicate in this snapshot of `UE1/index.php`, `UE2/index.php`, `new/index.php`; consolidation
